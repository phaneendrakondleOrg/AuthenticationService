...
dependencies {
    ...
    implementation ("org.springframework.boot:spring-boot-starter-web:3.3.5") // Upgraded to Spring Boot 3.3.5 (Spring Framework 6.1.14) to address CVE-2022-22965 (Spring4Shell)
